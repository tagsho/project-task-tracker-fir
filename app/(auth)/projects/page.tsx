      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="card">
          ...
          <dl className="space-y-2 text-xs">
            {[
              ['ステータス', <span className={clsx('badge', STATUS_COLOR[project.status as keyof typeof STATUS_COLOR])}>{STATUS_LABEL[project.status as keyof typeof STATUS_LABEL]}</span>],
              ...
              {phase.tasks?.map((task: any) => {
                ...
                return (
                  <div key={task.id} className="flex items-center gap-2 px-3 py-2 border-b border-gray-100 last:border-0 hover:bg-gray-50">
                    ...
                    <span className={clsx('badge', overdue ? 'bg-red-100 text-red-700' : STATUS_COLOR[task.status as keyof typeof STATUS_COLOR])}>
